...
import com.zp.library_news.newslist.NewsListFragment;
...
public class HeadlineNewsFragmentAdapter extends FragmentStatePagerAdapter {
    private ArrayList<ChannelModel.Channel> mChannels;

    public HeadlineNewsFragmentAdapter(FragmentManager fm) {
        super(fm);
    }

    public void setChannels(ArrayList<ChannelModel.Channel> channels) {
